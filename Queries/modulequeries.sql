...
-- Joining deparments and dept_managers tables
SELECT d.dept_name,
	dm.emp_no,
	dm.from_date,
	dm.to_date
...
-- List of current employees with salaries
SELECT e.emp_no, 
	e.first_name,
	e.last_name,
	e.gender,
...
-- List of employees including department	
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name
